...
#dossier = r'C:\Users\clara\Documents\M1\projet\test'
...
def parcourir_dossier(dossier,encodage='utf-8'):
    ...
    for element in os.listdir(dossier):
        ...
        if os.path.isdir(chemin_complet):
            ...
            try: 
                ...
                with open(chemin_complet, 'r', encoding=encodage) as fichier:
                ...
                parcourir_dossier(dossier,'ANSI')

            except :
                print(f"Problème sur le fichier : {chemin_complet} \n")
